...
#放回
Prob.Ar <- choose(8,4)*((5/8)^2)*((3/8)^2)
Prob.Ar
#不放回
...
bag <- rep(ball, c(3, 5))
#放回
back <- sample(bag, 4, replace = TRUE)
table(back)

#不放回
noback <- sample(bag, 4, replace = FALSE)
table(noback)
```
...
# your source code here
#放回
back.10 <- sample(bag, 10, replace = TRUE)
table(back.10)
#不放回
#由於求只有8顆，紅球最多抽出5次，白球最多抽出3次，最後2次沒有球
#此題無解
#noback.10 <- sample(bag, 10, replace = FALSE)
#table(noback.10)
...
# your source code here
#放回
back.1000 <- sample(bag, 1000, replace = TRUE)
table(back.1000)
#不放回
#由於求只有8顆，紅球最多抽出5次，白球最多抽出3次，最後992次沒有球
#此題無解
#noback.1000 <- sample(bag, 1000, replace = FALSE)
#table(noback.1000)
```
...
# your source code here
library(xlsx)
data1 <- read.xlsx("award-list.xlsx",1, startRow=1,encoding="UTF-8")
